...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    ...
    <div class="container">
        ...
        <h1>GMLsnip API Docs</h1>
			...
			<h2 class="question coll">API response</h2>
			<div class="coll-p">
				...
				<p>The JSON contains two objects:</p><ul><li><code>body</code> contains the HTML necessary to render the codeblock</li><li><code>head</code> contains the CSS used to style the codeblock and the JavaScript required to use the clipboard functionality.</li></ul><p><strong>Note:</strong> the JSON return strings are <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/encodeURI">URI encoded</a> and must be decoded. The reason for this is because the JSON contains HTML tags which browsers attempt to render.</p>
			</div>
